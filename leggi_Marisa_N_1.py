...
sca = map.scatter(x,y,c = col_c,s=5,edgecolors='none',vmin=0.2e12,vmax=2.9e12)
pl.colorbar()
...
map.drawparallels(np.arange(60,90,10))
x, y = map(pixs[cond].pg_lon,pixs[cond].pg_lat)
sca = map.scatter(x,y,c = temp,s=5,edgecolors='none',vmin=0.2e12,vmax=2.9e12)
pl.colorbar()
...
map.drawparallels(np.arange(60,90,10))
x, y = map(pixs[cond].pg_lon,pixs[cond].pg_lat)
sca = map.scatter(x,y,c = pixs[cond].emiss_angle,s=5,edgecolors='none',vmin=0.2e12,vmax=2.9e12)
pl.colorbar()
pl.show()